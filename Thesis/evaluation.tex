...
\begin{figure}[h!]
    ...
    \begin{subfigure}[c]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../Materalien/iouDist2.pdf}
        \subcaption{2D}
    \end{subfigure}
    \begin{subfigure}[c]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../Materalien/iouDist3.pdf}
        \subcaption{3D}
    \end{subfigure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{../Materalien/runtime_cnn.pdf}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        \node[anchor=south west,inner sep=0] at (0,0) {
            \includegraphics[width=\textwidth,trim={6cm 2cm 22cm 5cm},clip]{../Materalien/kittiBadImage.png}
        };
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        \node[anchor=south west,inner sep=0] at (0,0) {
            \includegraphics[width=\textwidth]{../Materalien/kittiBad.png}
        };
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[c]{0.3\textwidth}
        \includegraphics[width=\textwidth]{../Materalien/texture222_0.png}
        \subcaption{Car}
        \label{fig:eval:texture:222_0}
    \end{subfigure}
    \begin{subfigure}[c]{0.3\textwidth}
        \includegraphics[width=\textwidth]{../Materalien/texture222_1.png}
        \subcaption{Van}
        \label{fig:eval:texture:222_1}
    \end{subfigure}
    \begin{subfigure}[c]{0.3\textwidth}
        \includegraphics[width=\textwidth]{../Materalien/texture0_0.png}
        \subcaption{Sign}
        \label{fig:eval:texture:0_0}
    \end{subfigure}
    \begin{subfigure}[c]{0.3\textwidth}
        \includegraphics[width=\textwidth]{../Materalien/texture0_1.png}
        \subcaption{Rear of a car}
        \label{fig:eval:texture:0_1}
    \end{subfigure}
    \begin{subfigure}[c]{0.3\textwidth}
        \includegraphics[width=\textwidth]{../Materalien/texture0_2.png}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[c]{0.48\textwidth}
        \includegraphics[width=\textwidth]{../Materalien/iou2_lehr.pdf}
        \subcaption{2D}
    \end{subfigure}
    \begin{subfigure}[c]{0.48\textwidth}
        \includegraphics[width=\textwidth]{../Materalien/iou3_lehr.pdf}
        \subcaption{3D}
    \end{subfigure}
    \caption{Distribution of the IoU-Scores}
