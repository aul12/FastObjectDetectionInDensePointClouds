...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{.33\textwidth}
            \includegraphics[height=.45\textheight]{../Materalien/Presentation/Obstacle.pdf}
        \end{column}
        \pause
        \begin{column}{.33\textwidth}
            \includegraphics[height=.45\textheight]{../Materalien/Presentation/Pedestrian.pdf}
        \end{column}
        \pause
        \begin{column}{.33\textwidth}
            \includegraphics[height=.45\textheight]{../Materalien/Presentation/Sign.pdf}
        \end{column}
    \end{columns}
    \pause
    \begin{itemize}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../Materalien/Presentation/grid.png}
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../Materalien/Presentation/objects.png}
    \end{figure}
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth]{../CnnPresentation/res/image_0.png}
                \caption{Hindernis}
            \end{figure}
        \end{column}
        \begin{column}{.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth]{../CnnPresentation/res/image_2.png}
                \caption{Schild}
            \end{figure}
        \end{column}
    \end{columns}
